...
namespace MockStore
{
    public sealed class Db
    {
        ...
        {
            Products.Add(new Product(1, "randomEAN", 1, "Category 1", 1, "Brand1", "Item 1", "Description", 1.99m, true, null, "undercutters"));
            Products.Add(new Product(2, "randomEAN", 1, "Category 1", 1, "Brand1", "Item 2", "Description", 0.99m, true, null, "dodgy dealers"));
            Products.Add(new Product(3, "randomEAN", 1, "Category 1", 1, "Brand1", "Item 3", "Description", 5.99m, true, null, "bazzas bazaar"));
            Products.Add(new Product(4, "randomEAN", 1, "Category 1", 1, "Brand1", "Item 4", "Description", 0.50m, true, null, "undercutters"));
        }
